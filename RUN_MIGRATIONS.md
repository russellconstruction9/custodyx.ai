# 🚀 SUPABASE SETUP - COPY & PASTE IN 2 MINUTES

## Step 1: Open Supabase SQL Editor

**Click this link:** https://supabase.com/dashboard/project/xidaoszvrdgttvgrntfe/sql/new

## Step 2: Run Migration 1 (Create Tables)

Copy the ENTIRE content below and paste into SQL Editor, then click **"Run"**:
...
1. Go to: https://supabase.com/dashboard/project/xidaoszvrdgttvgrntfe/database/publications
2. Find `supabase_realtime` publication
3. Check the box next to **`messages`** table
4. Click **Save**

## ✅ Done!

Your database is now set up! Test your app at **http://localhost:3001**
...
**Note:** If you see any errors, check the browser console for details.
