                ...
                <footer className="p-4 border-t border-gray-200 flex justify-end gap-3 no-print">
                     {generatedPackage ? (
                        ...
                        <>
                            ...
                            {step === 2 && (
                                <button onClick={handleGeneratePackage} disabled={isLoading || !packageObjective.trim()} className="flex items-center px-4 py-2 text-sm font-semibold text-white bg-blue-950 rounded-md shadow-sm hover:bg-blue-800 disabled:bg-blue-300">
